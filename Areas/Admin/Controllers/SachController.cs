...
namespace BookStore.Areas.Admin.Controllers
{
    public class SachController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSach,TenSach,TacGia,NXB,Gia,Description,HinhAnh,MaLoai,NCC")] Sach sach, HttpPostedFileBase HinhAnh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSach,TenSach,TacGia,NXB,Gia,Description,HinhAnh,MaLoai,NCC")] Sach sach, HttpPostedFileBase HinhAnh)
        {
            if (ModelState.IsValid)
            {
                if (HinhAnh != null)
